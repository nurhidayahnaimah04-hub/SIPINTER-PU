...
export default function Login() {
  ...
  return (
    <>
      {/* Pengaturan CSS Responsif khusus Layar HP / Tablet */}
      <style>{`
        .login-wrapper {
          width: 100vw;
          min-height: 100vh;
        ...
        /* --- MENYESUAIKAN UKURAN LAYAR HP (MOBILE) --- */
        @media (max-width: 1024px) {
          ...
          .panel-kiri {
            display: none !important; /* Disembunyikan di HP agar tidak terpotong ke samping */
          }
      ...
      <div className="login-wrapper">
        ...
        {/* PANEL KIRI: Identitas Instansi & Branding (Sama Persis) */}
        <div className="panel-kiri">
        ...
        {/* PANEL KANAN: Form Login (Rata Tengah & Adaptif HP) */}
        <div className="panel-kanan">
          <div style={{ width: '100%', maxWidth: '440px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div className="header-mobile" style={{ display: 'none', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '20px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                <img src="/logo-bapekom.jpg" alt="Logo Bapekom" style={{ width: '40px', height: '40px', borderRadius: '50%' }} />
                <img src="/logo-sipinter.png" alt="Logo SIPINTER" style={{ width: '40px', height: '40px', objectFit: 'contain' }} />
              </div>
              <div style={{ fontSize: '11px', fontWeight: 700, color: '#F2A90A', textTransform: 'uppercase' }}>Kementerian Pekerjaan Umum</div>
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#07142E' }}>Balai Pengembangan Kompetensi PU Wilayah I Medan</div>
            </div>
